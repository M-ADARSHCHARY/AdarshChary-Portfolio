...
const Home = () => {
 ...
 useEffect(()=>{
  ...
  return (
    <section id="home" className="   min-h-[80vh] grid md:grid-cols-2 sm:grid-cols-1 relative font-sans flex-wrap mt-14">
        <div className="text-center z-10 px-4 p-4 w-full place-self-center">
