        ...
        <div className="max-w-5xl mx-auto px-4">
            ...
            <div className="grid grid-cols-1   gap-6">
                 <div className="p-6 rounded-xl border border-blue-900  hover:translate-y-1 hover:border-blue-500/30 ">
                    <h3 className="font-serif font-bold mb-0.2 bg-blue-900 inline-block p-2 rounded-md mb-1">Workout-Tracker</h3>
                    <p>
                 ...
                 {/*Project-2*/}
                 <div className="p-6 rounded-xl border border-blue-900  hover:translate-y-1 hover:border-blue-500/30 ">
                    <h3 className="font-serif font-bold mb-0.2 bg-blue-900 inline-block p-2 rounded-md mb-1">HelloW-ChatApp</h3>
                    <p>
