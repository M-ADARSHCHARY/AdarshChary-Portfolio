        ...
        <div className="max-w-5xl mx-auto px-4">
            ...
            <div className="grid grid-cols-1   gap-6">
                 ...
                 <div className="relative p-6 rounded-xl border border-blue-900  hover:translate-y-1 hover:border-blue-500/30 ">
                    ...
                    <div className="grid md:grid-cols-3 gap-2 grid-cols-2 mt-2 mb-4">
                        {
                            ["React.Js","TailwindCSS","Zustand","Node.Js","Express.Js","MongoDB-Atlas","JWT","Web-sockets","Cloudinary"].map((skill,key)=>(
                                <span key={key} className="text-blue-500 bg-blue-500/10 py-1 px-3 rounded-lg">
                                              {skill}
                                </span>
                            ))
                     ...
                     <a className="text-blue-900 hover:text-blue-700 flex gap-2 justify-end items-center absolute bottom-2 right-4"href="https://github.com/M-ADARSHCHARY/HelloW-Chat-App"><Link className="w-4 h-4"/>Explore the project on GitHub</a>
                 </div>   
            </div>
        </div>
    </section>
